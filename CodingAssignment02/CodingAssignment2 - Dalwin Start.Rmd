...
anova(model2, model)
```
Including the cities did not reduce the sum of squared errors by a significant amount due to P (0.9779) > alpha (0.05), meaning that adding the city variables did not really reduce the difference between the observed values and the predicted values. 
